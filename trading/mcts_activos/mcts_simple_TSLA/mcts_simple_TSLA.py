...
if __name__ == "__main__":
    ...
    # datos_resultado.csv — paneles 1, 2, 3 y 4 del gráfico principal
    ...
    # datos_violin_retornos.csv — retornos diarios de MCTS y B&H
    ...
    # datos_exposicion_dinamica.csv — posición diaria y acción tomada
