...
\begin{figure}[H]
    \begin{adjustbox}{center}
        \includegraphics[width=1.2\linewidth]{figuras/mcts_simple_resultado.png}
    \end{adjustbox}
...
\begin{figure}[H]
    \begin{adjustbox}{center}
        \includegraphics[width=1.2\linewidth]{figuras/mcts_exposicion_dinamica.png}
    \end{adjustbox}
...
\begin{figure}[H]
    \begin{adjustbox}{center}
        \includegraphics[width=1.2\linewidth]{figuras/mcts_convergencia_ucb.png}
    \end{adjustbox}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1.2\linewidth]{figuras/mcts_violin_retornos.png}
    \end{center}
