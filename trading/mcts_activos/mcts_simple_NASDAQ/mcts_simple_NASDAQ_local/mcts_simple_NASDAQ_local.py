...
DATOS_LOCAL   = os.path.join(os.path.dirname(__file__), f"precios_NASDAQ.csv")
...
def descargar_y_guardar_precios(ticker: str, periodo: str,
    ...
    Parámetros
    ----------
    ticker  : Símbolo del activo (ej. "EQQB.DE").
    periodo : Período en formato yfinance (ej. "2y").
    ruta    : Ruta donde se guardará el CSV (por defecto precios_NASDAQ.csv).
    """
